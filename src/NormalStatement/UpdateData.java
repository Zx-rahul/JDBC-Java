...
public class UpdateData {
    public static void main(String[] args) {
        ...
        String query = "UPDATE employees " +
                "SET job_title = 'Full Stack Developer', salary = 70000000 " +
                "WHERE id = 2;";//updation query
        try {//loading driver
        ...
        try {//establishing connection
            ...
            int rowsAffected = smt.executeUpdate(query);//updating data
            if (rowsAffected > 0) {//if updated
                System.out.printf("Update Successful %d row(s) affected.\n", rowsAffected);
            } else {//if not updated
